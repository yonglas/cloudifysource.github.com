...
<h4 class="info">For a more information about how to configure the EC2 cloud driver, see "Bootstrapping Cloudify on EC2":/guide/bootstrapping/bootstrapping_ec2.</h4>
